...
<html lang="en">
    ...
    <head>
        ...
        <meta name="theme-color" content="6777EE">
        <!-- Windows Phone -->
        <meta name="msapplication-navbutton-color" content="6777EE">
        <!-- iOS Safari -->
        <meta name="apple-mobile-web-app-status-bar-style" content="6777EE">
