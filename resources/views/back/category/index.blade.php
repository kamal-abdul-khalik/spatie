                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('categories.store') }}" method="post">
                                ...
                                @include('back.category.partials.form-controls')
                                ...
                                <table class="table table-striped" id="table-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('categories.edit', $category) }}" type="button" class="btn btn-sm btn-info"><i class="fa fa-pencil-alt"></i></a>
                                                <a href="{{ route('categories.destroy', $category) }}" type="button" class="btn btn-sm btn-danger" onclick="event.preventDefault();document.getElementById('destroy').submit();"><i class="fa fa-trash"></i></a>
                                                <form id="destroy" action="{{ route('categories.destroy', $category) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
