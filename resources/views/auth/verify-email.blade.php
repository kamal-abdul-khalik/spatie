                            ...
                            <div class="card-body">
                                ...
                                @if (session('status'))
                                    <div class="alert alert-success" role="alert">
                                        Email sudah terkirim ke <strong
                                ...
                                <form action="/email/verification-notification" method="post" class="mb-3">
                                    ...
                                    @else
                                        Silahkan <strong>Periksa folder email anda</strong> dan lakukan verifikasi email
                                        untuk mengaktifkan akun ini, jika belum menerima email verifikasi, silahkan klik
                                        tombol kirim ulang verifikasi.

                                        <button class="btn btn-sm btn-primary">Kirim ulang verifikasi</button>
                                    @endif
                                </form>
                                <small class="text-danger"><i class="fa fa-info-circle"></i> Pastikan Anda memeriksa folder
                                    spam pada email Anda jika email tidak masuk dalam folder email Anda</small>
                            </div>
                        </div>
                    </div>
                </div>
